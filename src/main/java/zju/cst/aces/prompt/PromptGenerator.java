...
//    }
    ...
    private void setCoverUpRepairData() {
        promptTemplate.dataModel.put("coverage_message", String.join(", ", COVERUP.coverage_message));
        promptTemplate.dataModel.put("uncovered_lines", String.join(", ", COVERUP.uncoveredLines));
    }
