...
public enum PromptFile {
    ...
    sofia_repair("PROMPT_TEMPLATE_SOFIA_REPAIR", "PROMPT_TEMPLATE_INIT_SYSTEM"),
    sofia_hits_slice_init("PROMPT_TEMPLATE_SOFIA_HITS_GEN_SLICE", "PROMPT_TEMPLATE_HITS_SYS_GEN"),
    sofia_hits_test_init("PROMPT_TEMPLATE_SOFIA_HITS_GEN", "PROMPT_TEMPLATE_HITS_SYS_GEN"),
