...
public enum PromptFile {
    ...
    sofia_init("PROMPT_TEMPLATE_SOFIA_INIT", "PROMPT_TEMPLATE_SOFIA_INIT_SYSTEM"),
    sofia_repair("PROMPT_TEMPLATE_SOFIA_REPAIR", "PROMPT_TEMPLATE_SOFIA_REPAIR_SYSTEM"),
    chatunitest_new_init("PROMPT_TEMPLATE_INIT", "PROMPT_TEMPLATE_SOFIA_INIT_SYSTEM"),
    chatunitest_new_repair("PROMPT_TEMPLATE_REPAIR", "PROMPT_TEMPLATE_SOFIA_REPAIR_SYSTEM"),
    sofia_old_init("PROMPT_TEMPLATE_SOFIA_INIT", "PROMPT_TEMPLATE_INIT_SYSTEM"),
